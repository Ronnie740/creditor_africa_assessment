    ...
    <div className='bg-gray-50/50 p-8 h-full rounded-l-2xl border-l border-gray-100'>
            ...
            <div className='flex justify-between items-start mb-2'>
              ...
              <div className='flex items-center bg-white rounded-md border border-gray-200 shadow-sm'>
                <Button 
                    variant="ghost" 
                    size="icon" 
                    className="h-8 w-8 rounded-none rounded-l-md hover:bg-gray-50"
                ...
                <Button 
                    variant="ghost" 
                    size="icon" 
                    className="h-8 w-8 rounded-none rounded-r-md hover:bg-gray-50"
                    onClick={() => updateQuantity(item.id, 1)}
                >
      ...
      <div className='mb-8'>
        ...
        <div className='flex gap-4'>
          <input className='flex-1 bg-white border border-gray-200 rounded-md px-4 py-3 outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all' />
          <Button className='bg-primary/10 text-primary hover:bg-primary/20 border border-primary/20 shadow-none'>Apply</Button>
        </div>
      </div>
