    ...
    <div className='bg-gray-50/50 p-8 h-full rounded-l-2xl border-l border-gray-100'>
      ...
      <div className='mb-8'>
        ...
        <div className='flex gap-4'>
          <input className='flex-1 bg-white border border-gray-200 rounded-md px-4 py-3 outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition-all' />
